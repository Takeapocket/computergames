...
generated_at: 2026-05-18T13:49:03
argv: ["--candidate-report", "reports/opening_light_screen.json", "--candidate-section", "results", "--candidate-index", "3", "--games-per-side", "4", "--seed-pool", "24026", "--output", "reports/opening_duel_curated_003_8g_20260518.md", "--json-output", "reports/opening_duel_curated_003_8g_20260518.json", "--decision-reason", "Top candidate from opening_light_screen 16x1; small expansion only, not promotion evidence."]
...
- combined: 62.5% (wins=5/8), CI95=[30.6%, 86.3%], illegal=0, crashes=0, timeouts=0, max_step_ms=720.3
- candidate as red: 50.0% (wins=2/4), illegal=0, crashes=0, timeouts=0, max_step_ms=720.3
- candidate as blue: 75.0% (wins=3/4), illegal=0, crashes=0, timeouts=0, max_step_ms=720.1
